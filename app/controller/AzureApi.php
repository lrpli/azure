...
class AzureApi extends BaseController
{
    ...
    public static function registerMainAzureProviders($client, $account, $provider)
    {
        ...
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/providers/' . $provider . '/register?api-version=2024-03-01';
        $client->post($url, [
    ...
    public static function getAzureResourceGroupsList($account_id, $az_sub_id)
    {
        ...
        $client = new Client();
        $url = 'https://management.azure.com/subscriptions/' . $az_sub_id . '/resourcegroups?api-version=2024-03-01';
        $result = $client->get($url, [
            'headers' => self::getToken($account_id),
        ]);
    ...
    public static function getAzureResourceGroup($account, $group_name)
    {
        ...
        $client = new Client();
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/resourcegroups/' . $group_name . '/resources?api-version=2024-03-01';
        $result = $client->get($url, [
            'headers' => self::getToken($account->id),
        ]);
    ...
    public static function getAzureNetworkInterfacesDetails($account_id, $network_interface_name, $resource_group_name, $subscription_id)
    {
        ...
        $client = new Client();
        $url = 'https://management.azure.com/subscriptions/' . $subscription_id . '/resourceGroups/' . $resource_group_name . '/providers/Microsoft.Network/networkInterfaces/' . $network_interface_name . '?api-version=2024-05-01&%24expand=ipConfigurations%2FpublicIPAddress%2CnetworkSecurityGroup';
        $result = $client->get($url, [
            'headers' => self::getToken($account_id),
        ]);
    ...
    public static function getAzureVirtualMachineStatus($account_id, $request_url)
    {
        ...
        $client = new Client();
        $url = 'https://management.azure.com' . $request_url . '/instanceView?api-version=2024-07-01';
        $result = $client->get($url, [
            'headers' => self::getToken($account_id),
        ]);
    ...
    public static function getAzureVirtualMachines($account_id)
    {
        ...
        $client = new Client();
        $url = 'https://management.azure.com/subscriptions/' . $azure_sub->az_sub_id . '/providers/Microsoft.Compute/virtualMachines?api-version=2024-07-01';
        $result = $client->get($url, [
            'headers' => self::getToken($account_id),
        ]);
    ...
    public static function readAzureVirtualMachinesList($account_id, $az_sub_id)
    {
        ...
        $client = new Client();
        $url = 'https://management.azure.com/subscriptions/' . $az_sub_id . '/providers/Microsoft.Compute/virtualMachines?api-version=2024-07-01';
        $result = $client->get($url, [
            'headers' => self::getToken($account_id),
        ]);
    ...
    public static function manageVirtualMachine($action, $account_id, $request_url)
    {
        ...
        $client = new Client();
        $url = 'https://management.azure.com' . $request_url . '/' . $action . '?api-version=2024-07-01';
        $client->post($url, [
            'headers' => self::getToken($account_id),
        ]);
    }
    ...
    public static function virtualMachinesDeallocate($account_id, $request_url)
    {
        ...
        $client = new Client();
        $url = 'https://management.azure.com' . $request_url . '/deallocate?api-version=2024-07-01';
        $client->post($url, [
            'headers' => self::getToken($account_id),
        ]);
    }
    ...
    {
        $client = new Client();
        $url = 'https://management.azure.com/subscriptions/' . $subscription_id . '/resourcegroups/' . $resource_group_name . '?api-version=2024-03-01';
        $client->delete($url, [
            'headers' => self::getToken($account_id),
        ]);
    }
    ...
    public static function deleteAzureResourcesGroupByUrl($url)
    {
        ...
        $client = new Client();
        $url = 'https://management.azure.com' . $url . '?api-version=2024-03-01';
        $client->delete($url, [
            'headers' => self::getToken($account->id),
        ]);
    }
    ...
    public static function createAzureResourceGroup($client, $account, $resource_group_name, $location)
    {
        ...
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/resourcegroups/' . $resource_group_name . '?api-version=2024-03-01';
        $client->put($url, [
    ...
    public static function createNetworkSecurityGroups(
        ...
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/resourcegroups/' . $resource_group_name . '/providers/Microsoft.Network/networkSecurityGroups/' . $name . '?api-version=2024-05-01';
    ...
    public static function createAzurePublicNetworkIpv4(
        ...
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/resourceGroups/' . $resource_group_name . '/providers/Microsoft.Network/publicIPAddresses/' . $ip_name . '?api-version=2024-05-01';
    ...
    public static function countAzurePublicNetworkIpv4($client, $account, $location): int
    {
        ...
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/providers/Microsoft.Network/publicIPAddresses?api-version=2024-05-01';
        $result = $client->get($url, [
            'headers' => self::getToken($account->id, true),
        ]);
    ...
    public static function createAzureVirtualNetwork(
        ...
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/resourceGroups/' . $resource_group_name . '/providers/Microsoft.Network/virtualNetworks/' . $virtual_network_name . '?api-version=2024-05-01';
    ...
    public static function createAzureVirtualNetworkSubnets(
        ...
        $subnet_url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/resourceGroups/' . $resource_group_name . '/providers/Microsoft.Network/virtualNetworks/' . $virtual_network_name . '/subnets/default?api-version=2024-05-01';
    ...
    public static function createAzureVirtualNetworkInterfaces(
        ...
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/resourceGroups/' . $vm_name . '_group/providers/Microsoft.Network/networkInterfaces/' . $vm_name . '_vif?api-version=2024-05-01';
    ...
    public static function createAzureVm($client, $account, $vm_name, $vm_config, $vm_image, $interfaces, $location)
    {
        ...
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/resourceGroups/' . $vm_name . '_group/providers/Microsoft.Compute/virtualMachines/' . $vm_name . '?api-version=2024-07-01';
    ...
    public static function getVirtualMachineStatistics($server, $start_time = null, $end_time = null)
    {
        ...
        $client = new Client();
        $url = 'https://management.azure.com' . $server->request_url . '/providers/Microsoft.Insights/metrics?api-version=2023-10-01&timespan=' . $start_time . '/' . $end_time . '&interval=PT1H&aggregation=total%2Caverage&metricnames=Percentage%20CPU%2CCPU%20Credits%20Remaining%2CAvailable%20Memory%20Bytes%2CNetwork%20In%20Total%2CNetwork%20Out%20Total';
        $result = $client->get($url, [
    ...
    public static function virtualMachinesResize($new_size, $location, $account_id, $request_url)
    {
        ...
        $url = 'https://management.azure.com' . $request_url . '?api-version=2024-07-01';
    ...
    public static function virtualMachinesRedisk($new_size, $server)
    {
        ...
        $url = 'https://management.azure.com/subscriptions/' . $server->at_subscription_id . '/resourceGroups/' . $server->resource_group . '/providers/Microsoft.Compute/disks/' . $vm_disk_name . '?api-version=2024-03-01';
    ...
    public static function getQuota($account, $location)
    {
        ...
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/providers/Microsoft.Capacity/resourceProviders/Microsoft.Compute/locations/' . $location . '/serviceLimits?api-version=2023-12-15-preview';
    ...
    public static function getDisks($server)
    {
        ...
        $url = 'https://management.azure.com/subscriptions/' . $server->at_subscription_id . '/resourceGroups/' . $server->resource_group . '/Providers/Microsoft.Compute/disks/' . $disk_name . '?api-version=2024-03-02';
    ...
    public static function getResourceSkusList($client, $account, $location)
    {
        ...
        $url = 'https://management.azure.com/subscriptions/' . $account->az_sub_id . '/Providers/Microsoft.Compute/skus/?api-version=2021-07-01&$filter=location eq ' . "'" . $location . "'";
